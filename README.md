...
## 📥 How to Download Aura on Windows
...
6. Save the file to a folder you can easily find, like your Desktop or Downloads folder.

## ▶️ How to Run Aura on Windows

After downloading the executable file, follow these steps to start Aura:

1. Open the folder where you saved the file.
2. Double-click the `.exe` file to launch Aura.
3. You may see a security warning from Windows. Click "Run" or "More Info" and then "Run Anyway" to allow the program.
4. Aura will open a terminal or command window. It may ask for some input or show status messages.
5. If required, type the commands or settings provided by your network administrator or set up the tunnel parameters based on your usage.
6. To stop Aura, simply close the command window.
...
- Run the program as Administrator by right-clicking the `.exe` and selecting "Run as administrator."
