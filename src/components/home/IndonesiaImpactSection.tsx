...
export const IndonesiaImpactSection: React.FC<IndonesiaImpactSectionProps> = ({ language }) => {
  ...
  return (
    <section 
      id="indonesia" 
      className={`py-6 ${isMobile ? 'py-6' : 'py-8'} bg-white dark:bg-gray-900`}
      aria-labelledby="indonesia-impact-heading"
    >
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-6 md:mb-8">
          <h2 
            id="indonesia-impact-heading"
            className={`${isMobile ? 'text-2xl' : 'text-3xl'} font-bold mb-3 dark:text-white`}
          >
