...
export const QuickInvestment: React.FC<QuickInvestmentProps> = ({ language = 'en' }) => {
  ...
  const content = {
    en: {
      ...
      directInvestPoint2: "We automatically convert your investment to $AKR tokens",
      directInvestPoint3: "Start earning returns immediately",
      browseProjects: "Browse Projects",
      dexPurchase: "DEX/CEX Purchase",
      dexPoint1: "Buy $AKR tokens on supported exchanges",
    ...
    id: {
      ...
      directInvestPoint2: "Kami secara otomatis mengkonversi investasi Anda menjadi token $AKR",
      directInvestPoint3: "Mulai dapatkan hasil segera",
      browseProjects: "Jelajahi Proyek",
      dexPurchase: "Pembelian DEX/CEX",
      dexPoint1: "Beli token $AKR di bursa yang didukung",
