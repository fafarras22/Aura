...
export const Footer = () => {
  ...
  return (
    <footer className="w-full bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 px-6 py-8 mt-auto">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-semibold text-sm mb-4">AKAR FarmWatch</h3>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-medium">AKAR</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Advanced Container Agriculture for Sustainable Food Production
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/whitepaper" className="text-muted-foreground hover:text-foreground transition-colors">
                  Whitepaper
                </Link>
              </li>
              <li>
                <Link to="/tokenization" className="text-muted-foreground hover:text-foreground transition-colors">
                  Tokenization
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between">
          <p className="text-xs text-muted-foreground">
            &copy; {currentYear} AKAR FarmWatch. All rights reserved.
          </p>
