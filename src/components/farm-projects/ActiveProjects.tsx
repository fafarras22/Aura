...
export const ActiveProjects: React.FC = () => {
  ...
  const handleClaim = (projectId: string, amount: number) => {
    toast({
      ...
      description: `Claiming ${amount} AKR from project ${projectId}`,
    });
  };
                    ...
                    <div className="flex-1 p-6">
                      <div className="flex flex-col md:flex-row justify-between gap-4">
                        ...
                        <div className="flex flex-wrap gap-3">
                          ...
                          >
                            ...
                            Claim {project.pendingRewards} AKR
                          </Button>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
                        <div>
                          ...
                          <p className="text-xl font-bold">{project.stakedAmount} AKR</p>
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold">{project.pendingRewards} AKR</p>
