...
export const TokenPurchase = ({ tokenData }: TokenPurchaseProps) => {
  ...
  return (
    <div className="space-y-6">
      {/* Purchase card - moved to the top */}
      <Card className="bg-white dark:bg-gray-800 shadow-md border-0">
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 border-green-200 dark:from-green-900/20 dark:to-green-800/20 dark:border-green-800 p-4 rounded-lg flex items-center">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-100 dark:border-green-800 flex items-center">
              <div className="bg-green-100 dark:bg-green-800 p-2 rounded-full mr-3">
                <TrendingUp className="h-4 w-4 text-green-700 dark:text-green-300" />
              </div>
              <div>
                <p className="text-sm font-medium text-green-800 dark:text-green-300">Average Annual Return: {tokenData.averageReturn}%</p>
                <p className="text-xs text-green-700 dark:text-green-400">Based on historical performance over 12 months</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-md">
                <div className="flex items-center gap-2">
      ...
      {/* Portfolio card - moved below purchase */}
      <Card className="bg-white dark:bg-gray-800 shadow-md border-0">
        <CardHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 border rounded-lg dark:border-gray-700">
                ...
                <p className="text-xl font-bold text-green-600 dark:text-green-400">+15.4 MATIC</p>
              </div>
            </div>
              ...
              <div className="divide-y dark:divide-gray-700">
                {(tokenData.recentTransactions || [
                  ...
                  <div key={transaction.id} className="flex justify-between px-4 py-3 text-sm">
                    ...
                    <div className={`font-medium ${transaction.type === 'Reward' ? 'text-green-600 dark:text-green-400' : ''}`}>
